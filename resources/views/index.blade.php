...
<head>
    ...
    <link href="{{asset('page_css/bootstrap.css')}}" rel="stylesheet" type="text/css" media="all" />
    <!--jQuery(necessary for Bootstrap's JavaScript plugins)-->
    <script src="{{asset('page_js/jquery-1.11.0.min.js')}}"></script>
    <!--Custom-Theme-files-->
    <!--theme-style-->
    <link href="{{asset('page_css/style.css')}}" rel="stylesheet" type="text/css" media="all" />
    <!--//theme-style-->
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
    ...
    <!--start-menu-->
    <script src="{{asset('page_js/simpleCart.min.js')}}"> </script>
    <link href="{{asset('page_css/memenu.css')}}" rel="stylesheet" type="text/css" media="all" />
    <script type="text/javascript" src="{{asset('page_js/memenu.js')}}"></script>
    <script>$(document).ready(function(){$(".memenu").memenu();});</script>
    <!--dropdown-->
    <script src="{{asset('page_js/jquery.easydropdown.js')}}"></script>
</head>
<body>
<!--top-header-->
